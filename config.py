...
#
# Порядок категорий определяет порядок их отображения в панели.
...
# Текущая механика внезапного нападения универсальна и работает для любого
# моба. Этот набор хранит известные особенности для будущих стратегий,
# статистики и отображения в панели.
...
# Плоский список сохраняется как совместимый интерфейс для существующей
# логики фармера. Он автоматически собирается из категорий с сохранением
# указанного порядка приоритета.
